 ...
 */
public class Tc_AllasidoRogzito extends javax.swing.JFrame {

    /**
     * Creates new form Tc_AllasidoRogzito
     */
    Tc_Besheet b;

    public Tc_AllasidoRogzito(Tc_Besheet b) {
        this.b = b;
        initComponents();
        seticon();
        jLabel2.setText(b.jTable2.getColumnName(b.jTable2.getSelectedColumn()));
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Planning", "Termelés", "Berendezés", "Folyamat és Mérnökség", "Quality", "Karbantartás", "Facility" }));
...
//mentés gomb az állásidő rögzítésénél
        int infsor = 0;
...
//kell a pktomig
        String pktomig = b.tablaadat[b.jTable2.getSelectedRow() - infsor - 1][b.jTable2.getSelectedColumn()].pktomig;

//kell hogy legyen pktomig
        if (pktomig.equals("")) {

            JOptionPane.showMessageDialog(this,
                    "Ebbe a mezőbe nem vehetsz fel állásidőt!",
                    "Hiba!",
        ...
        //beállítjuk a cellclassban , hogy van állásidő felvéve ide
        //lecsekkoljuk , hogy van e valami kiválasztva a combo boxban
        if (jComboBox1.getSelectedIndex() == -1) {

            //custom title, error icon
            JOptionPane.showMessageDialog(this,
                    "Nem választottál ki felelőst!",
                    "Hiba!",
                    JOptionPane.ERROR_MESSAGE);
            return;
...
//kell a dátum a megfelelő formátumban , tól ig
        String tol = this.jLabel2.getText().substring(0, 10) + " " + jSpinner1.getValue().toString() + ":" + jSpinner2.getValue().toString();
        String ig = this.jLabel2.getText().substring(0, 10) + " " + jSpinner3.getValue().toString() + ":" + jSpinner4.getValue().toString();
...
//ha az óra 0-5 között van akkor hozzá kell adni egy napot mert akkor az már a másik nap
        ...
        if (jSpinner1.getValue().equals("00") || jSpinner1.getValue().equals("01") || jSpinner1.getValue().equals("02") || jSpinner1.getValue().equals("03") || jSpinner1.getValue().equals("04") || jSpinner1.getValue().equals("05")) {
            ...
            DateTime dt = formatter.parseDateTime(this.jLabel2.getText().substring(0, 10));
...
//ha minden ellenőrzésen átmegyünk
        b.tablaadat[b.jTable2.getSelectedRow() - infsor][b.jTable2.getSelectedColumn()].all = 1;
        b.jTable2.repaint();

        //kell egy query 
        String query = "insert into downtimes_production (line , datefrom , dateto , downtimename , comments , pktomig) values ('" + Tc_Betervezo.Tervezotabbed.getTitleAt(Tc_Betervezo.Tervezotabbed.getSelectedIndex()) + "','" + tol + "','" + ig + "','" + jComboBox1.getSelectedItem().toString() + "','" + jTextArea1.getText() + "','" + pktomig + "')";
        planconnect pc = new planconnect();
        pc.feltolt(query, false);

//a tervben is egyesre kell allitani az allasidos adatot
        query = "update tc_terv set tc_terv.all = 1 where tc_terv.pktomig = '" + pktomig + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tc_AllasidoRogzito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
////            public void run() {
////                new Tc_AllasidoRogzito().setVisible(true);
////            }
//        });
    }
