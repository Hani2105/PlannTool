...
public class CTB_NEW_TopShortThread extends Thread {
    ...
    public void run() {
        ...
        if (!CTB_NEW_Variables.topshortthread) {
            CTB_NEW_Variables.topshortthread = true;
            String pn = "";
//addig csináljuk míg a kijelölés nem egyezik azzal a pn-el amit felvettünk, do while mert egyszer le kő futnyi
            do {
                ...
                try {
                    ...
                    CTB_NEW_Variables.topshortthread = false;
                    return;
...
//bellítjuk a shortmodellbe ezt az adathalmazt
            ...
            } //addig futunk míg nem egyezik a felvett pn a kijelöléssel
            while (!pn.equals(CTB.jTable11.getValueAt(CTB.jTable11.getSelectedRow(), 0).toString()));
