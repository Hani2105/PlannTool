...
//ha nincs bekapcsolva a boost az adott sheeten
        if (!Tc_Betervezo.Besheets.get(Tc_Betervezo.Tervezotabbed.getTitleAt(Tc_Betervezo.Tervezotabbed.getSelectedIndex())).jCheckBox5.isSelected()) {
