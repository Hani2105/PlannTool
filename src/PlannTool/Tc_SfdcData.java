...
//        tol = df.format(jDateChooser1.getDate()) + "%20" + jLabel3.getText().substring(0, 5);
//        DateTime dtorg = new DateTime(jDateChooser1.getDate());
//
//        if ((jRadioButton1.isSelected() && (jComboBox1.getSelectedIndex() == 1 || jComboBox1.getSelectedIndex() == 2)) || (jRadioButton2.isSelected() && jComboBox1.getSelectedIndex() == 2)) {
//
//            dtorg = dtorg.plusDays(1);
//
//            ig = df.format(dtorg.toDate()) + "%20" + jLabel3.getText().substring(6, 11);
//
//        } else {
//
//            ig = df.format(dtorg.toDate()) + "%20" + jLabel3.getText().substring(6, 11);
